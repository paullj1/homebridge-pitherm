/*
 *  Homebridge config should contain an accessory that looks like this:
 *
 ...
 *
 * Where the API can support basic authentication.  The optional maxTemp and
 * minTemp are the bounds that iOS puts on the slider that it will create.
 *
 * API Route should support the following:
 *
